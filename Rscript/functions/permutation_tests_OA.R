...
#   
#   EvenDiff<-All_boots_wide %>%
#     select(rep,countries,EvenDiff) %>% 
#     dplyr::rename("value"="EvenDiff")
#   RichDiff$metric<-"EvenDiff"
#   
#   All_boots_long_fig<-bind_rows(DivDiff,RichDiff,EvenDiff)
