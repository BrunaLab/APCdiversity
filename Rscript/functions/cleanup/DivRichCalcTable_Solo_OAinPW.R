...
# 
  DivRichCalcTable_Solo_MSv2<-function(sole_ALL,
                                  sole_NOCHNUSA,
                                  BootOAinPW_SoloAll,
                                  BootOAinPW_SoloNoUSACHN
                                  ){
    

    # DataSet1<-sole_ALL
    # DataSet2<-sole_NOCHNUSA
    # BootOAinPW_SoloAll<-BootOAinPW_SoloAll[1]
    # BootOAinPW_SoloNoUSACHN<-BootPW_SoloNoUSACHN[1]
    # JrnlType<-"OA"
  ...
  JrnlType<-"OA"
  Div_OA_pool_first<-DivRichCalc(sole_ALL,AuPosition,JrnlType)
  ...
  #######################################################################
  ##################################################
  # OA STATS -- NO CHN or USA
  
  source("./Rscript/functions/DivRichCalc.R") 
  AuPosition<-"author_first"
  JrnlType<-"OA"
  Div_OA_pool_first_noCHNorUSA<-DivRichCalc(sole_NOCHNUSA,"author_first",JrnlType)
