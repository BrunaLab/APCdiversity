bootstrap_PW<-function(Dataset,AuPosition) {
#############################################################################################
...
# Dataset <- first_ALL
  # Dataset <-sole_ALL
# Dataset <- AllData
  # Dataset <-AllData_no22
  # Dataset<-Dataset %>% 
  # Dataset<-AllData_no22_first
  # Dataset<-sampling_data
  # Dataset<-sampling_data_noCHNUSA
  # Dataset<-AllData_no22_first
...
N_check<-as.data.frame(Prep_for_samplePW[3])
N_check
# n<-Prep_for_samplePW[3]
n<-unlist(n)
sum(n)
sum(n)*2
