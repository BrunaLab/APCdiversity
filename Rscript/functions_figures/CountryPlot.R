CountryPlot<-function(DataSet,AuPosition,JrnlType) {

library(tidyverse)  
  # DataSet<-sole_author_pubs_ALL_first_author
...
library(countrycode)
  ...
  AllGeo$IncomeGroup <- ordered(AllGeo$IncomeGroup, 
    ...
    CountryPlot
# 
#     axis.title.x=element_text(ifelse(vars[3]=="PW",
#                                      ('colour="black", size = 12, vjust=-0.5'),
#                                      ('element_blank()'))),
