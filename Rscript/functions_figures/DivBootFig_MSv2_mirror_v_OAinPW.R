DivBootFig_MSv2<-function(Boot_RichDiv,sole_ALL,sole_NOCHNUSA,JrnlType) {
  ...
  Dataset<-rep(c("All Countries","CHN & USA excluded"),4)
  OA_articleType<-c(rep("mirror",4),rep("OAinPW",4))
