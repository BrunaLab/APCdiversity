DivBootFig_MSv2<-function(Boot_RichDiv,sole_ALL,sole_NOCHNUSA,author_type) {
  ...
  pDiv<-
    ...
    # ylim(0,170)+
    # ALL
    geom_segment(data = subset(filter(figure_values, BootType == "MirrorvPW" & Dataset == "All Countries" & author=="solo")),
                 aes(x = OA_Div , y = 0, xend = OA_Div, yend = ySolo_Div-10), 
                 colour = "red",linetype="solid")+
    geom_text(data = subset(filter(figure_values, author == "solo" & Dataset == "All Countries" & BootType == "MirrorvPW")),
    ...
    geom_text(data = subset(filter(figure_values, author == "solo" & Dataset == "All Countries" & BootType == "MirrorvPW")),
              ...
              parse=TRUE,size=2)+
    # NO CHN USA
    geom_segment(data = subset(filter(figure_values,BootType == "MirrorvPW"  & Dataset == "CHN & USA excluded" & author=="solo")),
                   aes(x = OA_Div , y = 0, xend = OA_Div, yend = ySolo_Div-10), 
                   colour = "red",linetype="solid")+
    geom_text(data = subset(filter(figure_values,author == "solo" & Dataset == "CHN & USA excluded" & BootType == "MirrorvPW")),
                aes(x=OA_Div-0, y=ySolo_Div+15, label=(paste("OA",as.character(OA_Div),sep=" == "))),
                parse=TRUE,color="red", size=2)+
    geom_segment(data = subset(filter(figure_values,BootType == "MirrorvPW"  & Dataset == "CHN & USA excluded" & author=="solo")),
    ...
    geom_segment(data = subset(filter(figure_values,BootType == "MirrorvOAinPW" & Dataset == "All Countries" & author=="solo")),
                 aes(x = OA_Div , y = 0, xend = OA_Div, yend = ySolo_Div), 
                 colour = "red",linetype="solid")+
    geom_text(data = subset(filter(figure_values,author == "solo" & Dataset == "All Countries" & BootType == "MirrorvOAinPW")),
    ...
    geom_text(data = subset(filter(figure_values,author == "solo" & Dataset == "All Countries" & BootType == "MirrorvOAinPW")),
              ...
              parse=TRUE,size=2)+
    # NO CHN USA
    geom_segment(data = subset(filter(figure_values,BootType == "MirrorvOAinPW" & Dataset == "CHN & USA excluded" & author=="solo")),
                 aes(x = OA_Div, y = 0, xend = OA_Div, yend = yWO_Div), 
                 colour = "red",linetype="solid")+
    geom_text(data = subset(filter(figure_values,author == "solo" & Dataset == "CHN & USA excluded" & BootType == "MirrorvOAinPW")),
    ...
    geom_segment(data = subset(filter(figure_values,author == "solo" & Dataset == "All Countries" & BootType == "OAinPWvPW")),
                 aes(x = OA_Div, y = 0, xend = OA_Div, yend = yWO_Div),  
                 colour = "red",linetype="solid")+
    geom_text(data = subset(filter(figure_values,author == "solo" & Dataset == "All Countries" & BootType == "OAinPWvPW")),
    ...
    geom_segment(data = subset(filter(figure_values,author == "solo" & Dataset == "CHN & USA excluded" & BootType=="OAinPWvPW")),
                 aes(x = OA_Div, y = 0, xend = OA_Div, yend = yWO_Div), 
                 colour = "red",linetype="solid")+
    geom_text(data = subset(filter(figure_values,author == "solo" & Dataset == "CHN & USA excluded" & BootType=="OAinPWvPW")),
