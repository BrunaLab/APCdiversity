...
\caption{(\#tab:TableA1-18)Countries eligible for APC waivers through Elsevier's 'Research4Life' program by World Bank Global Region and Income Group.}
\resizebox{\linewidth}{!}{
...
\caption{(\#tab:TableA2-19)Results of permutation tests comparing the difference in diversity and richness of (A) articles in Mirror journals and (B) open access articles in parent journals.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
...
\caption{(\#tab:TableA4-21)Number of Open Access (OA) and non-OA articles in Mirror and Parent journals. Values are given for both the collection of articles with all countries included and the one from which first authors based in China or the USA are excluded.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
