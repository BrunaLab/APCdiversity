...
```{r FigA1,fig.align='center',fig.cap="Percentage of lead authors based in different countries. Includes both paywalled and open access journals. Lead authors includes the authors of sole-authored papers and first authors of co-authored papers. Numbers adjacent to bars are the number of lead authors based in each country.", message = FALSE,warning=FALSE}
source("./Rscript/functions_figures/AppFig1.R") 
AppFig1(AllData)
```

```{r FigA2,fig.align='center', fig.cap="Author Geographic Diversity (Shannon Index) for pooled Open Access articles (red bar) and 1000 identically sized collections of Paywalled articles selected by bootstrapping. The black line indicates the mean value for the 1000 bootstrap collections.", fig.fullwidth=TRUE,message = FALSE,warning=FALSE}
source("./Rscript/functions_figures/DivBootFig_shannon.R") 
DivBootFig_shannon(bootstrap_results)
```

```{r FigA3,fig.align='center', fig.cap="Proportion of authors of (A) Open Access and (B) Paywalled articles based in different World Bank Lending Groups.",fig.fullwidth=TRUE,message = FALSE,warning=FALSE}
...
\newpage
\blandscape
```{r AppTable, echo=FALSE,message = FALSE,warning=FALSE}
